...
if len(opt.image_folder) == 0:
    ...
    print('use dataloader___RAW___')
    #print('eval_opt.batch_size :', opt.batch_size)
...
if opt.dump_json == 1:
    ...
    json.dump(split_predictions, open('predictions/volquelme_pred_'+str(infos['opt'].id)+'.json', 'w'))