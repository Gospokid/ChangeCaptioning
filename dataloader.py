...
class DataLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.use_att:
            ...
            #att_feat_2 = np.load(os.path.join(self.input_att_dir, str(self.info['images'][ix]['id']) + '_2.npz'))['feat']
            #att_feat_diff = np.load(os.path.join(self.input_att_dir, str(self.info['images'][ix]['id']) + '_diff.npz'))['feat']
            #att_feat = (att_feat_1 + att_feat_2 + att_feat_diff * 3) / 5
            # Reshape to K x C
            ...
            if self.use_box:
                ...
                #box_feat_2 = np.load(os.path.join(self.input_box_dir, str(self.info['images'][ix]['id']) + '_2.npy'))
                #box_feat_diff = np.load(os.path.join(self.input_box_dir, str(self.info['images'][ix]['id']) + '_diff.npy'))
                #box_feat = (box_feat_1 + box_feat_2 + box_feat_diff) / 3
        ...
        # volquelme code : ~ return
        fc_feat = np.load(os.path.join(self.input_fc_dir, str(self.info['images'][ix]['id']) + '.npy'))
        #fc_feat_2 = np.load(os.path.join(self.input_fc_dir, str(self.info['images'][ix]['id']) + '_2.npy'))
        #fc_feat_diff = np.load(os.path.join(self.input_fc_dir, str(self.info['images'][ix]['id']) + '_diff.npy'))
        #mean_fc_feat = (fc_feat_1 + fc_feat_2 + fc_diff*3) / 5
